package com.baili.service.generator;
...
public class MysqlGenerator {
    ...
    private static String packageName="baili";    //文件路径
    private static String authorName="zheng.th";     //作者
    private static String table="sc_user";                  //table名字
    private static String prefix="zth_";                     //table前缀
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new DataSourceConfig()
                        ...
                        .setUsername("hrms")
                        .setPassword("123456")
                        .setUrl("jdbc:mysql://172.17.210.180:3306/hrms?characterEncoding=utf8")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
